...
#import "MMSensorType.h"

@interface MMSensor : NSObject

@property (strong) NSString *smcKey;
...
@property (strong) NSString *humanReadableName;
@property (assign, atomic, readonly) NSString *valueString;
