...
#define MMSensorTypeTemperature @"temperature"
#define MMSensorTypeTachometer @"tachometer"
#define MMSensorTypeVoltage @"voltage"
#define MMSensorTypeCurrent @"current"
#define MMSensorTypePower @"power"
